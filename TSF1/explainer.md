...
Windows Input stack has since evolved from TSF1.0 into what is called a TSF3.0<sup>[1](#tsf3footnote1today)</sup>. We considered TSF3.0 as an alternative as well but leaned towards TSF1.0. New TSF3 features such as [content links](https://docs.microsoft.com/en-us/windows/uwp/design/controls-and-patterns/content-links) doesn't provide any additional value to Chromium. In addition, TSF3.0 APIs are accessed through WinRT layer which is not available on Windows down-level.
